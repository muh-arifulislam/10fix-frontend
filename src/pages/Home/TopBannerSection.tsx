...
const TopBannerSection = () => {
  ...
  return (
    <section className="px-0 2xl:px-4">
      <section
        style={{
          backgroundImage: `url(${heroBg})`,
        }}
        className={`w-full max-w-screen-2xl mx-auto h-auto  md:h-[596px] lg:md:sm:bg-cover bg-no-repeat lg:md:sm:bg-center bg-right-top relative mb-0 sm:mb-[150px] ${
